...
fuentes_sistema = [
    ...
    "Consolas"  #esta es la nueva fuente agregada
]


cuento_contado = [
    "Erase una vez un pequeño programador",
    "Cada día exploraba la pantalla buscando aventuras.",
    "Un día encontró un botón mágico que cambiaba las fuentes.",
    "Desde entonces, cada letra contaba una historia, el escritor es gerardo mercado"
]
...
class EfectosTexto:
    ...
    @staticmethod
    def texto_invertido(fuente, texto, tamaño, color_base):
        """Efecto de texto invertido: colores negativos"""
        texto_render = fuente.render(texto, color_base, size=tamaño)
        surf = texto_render[0].copy()
        ancho, alto = surf.get_size()
        
        # Invertir los colores
        for y in range(alto):
            for x in range(ancho):
                r, g, b, a = surf.get_at((x, y))
                surf.set_at((x, y), (255 - r, 255 - g, 255 - b, a))
...
while ejecutando:
    ...
    for evento in pygame.event.get():
        if evento.type == pygame.QUIT:
            ...
            # Tecla E - Cambiar efecto de texto
                ...
                efectos = ["normal", "sombra", "borde", "degradado", "neumorfico", "invertido"]
    ...
    "Desde entonces, cada letra contaba una historia, el escritor es gerardo mercado"
            ...
            # Tecla C - Cambiar color del texto
                ...
                colores = [BLANCO, ROJO, VERDE, AZUL, MORADO, AMARILLO, NARANJA, TURQUESA, ROSA]
