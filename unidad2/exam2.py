...
pygame.display.set_caption("Fuentes examU2 Gerardo Mercado Hurtado/Agustin Paniagua Flores")
...
fuentes_sistema = [
    ...
    "Consolas", "Century Gothic"  #esta es la nueva fuente agregada
]
    ...
    for evento in pygame.event.get():
        if evento.type == pygame.QUIT:
            ...
            # Tecla T - Cambiar texto de ejemplo
                ...
                textos = [
                    "hola", "pasare", "este", "examen", "con", "10"
                ]
